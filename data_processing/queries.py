...
create_tsv(data = processed_data[:3000000], file_name = "/home/lamdo/keyphrase_informativeness_test/splade/data/keyphrase_informative_scirepeval/triplets/raw.tsv")
    
#     for pos in positives:
#         if not pos: continue

#         chosen_negative = random.choice(negatives)
#         processed_data.append([query, pos, chosen_negative])
