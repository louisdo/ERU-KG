...
EXPERIMENT_NAME="doris_mae_uokg-1 [doc expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py

INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_only_present_keyphrase_expansion_uokg-1" \
EXPERIMENT_NAME="doris_mae_uokg-1 [doc present keyphrase expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py

INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_keyphrase_expansion_uokg-1" \
EXPERIMENT_NAME="doris_mae_uokg-1 [query + doc expansion]" \
QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/doris_mae_queries--uokg-1.json" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py
...
INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae" \
EXPERIMENT_NAME="doris_mae_autokeygen-1 [query expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
...
INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_only_present_keyphrase_expansion_autokeygen-1" \
EXPERIMENT_NAME="doris_mae_autokeygen-1 [doc present keyphrase expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py

INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_keyphrase_expansion_autokeygen-1" \
EXPERIMENT_NAME="doris_mae_autokeygen-1 [query + doc expansion]" \
QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/doris_mae_queries--autokeygen-1.json" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py
...
INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae" \
EXPERIMENT_NAME="doris_mae_copyrnn-1 [query expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
...
INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_only_present_keyphrase_expansion_copyrnn-1" \
EXPERIMENT_NAME="doris_mae_copyrnn-1 [doc present keyphrase expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py

INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_keyphrase_expansion_copyrnn-1" \
EXPERIMENT_NAME="doris_mae_copyrnn-1 [query + doc expansion]" \
QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/doris_mae_queries--copyrnn-1.json" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py
...
EXPERIMENT_NAME="doris_mae_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v6-1_position_penalty+length_penalty [doc expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py

INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_only_present_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v6-1_position_penalty+length_penalty" \
EXPERIMENT_NAME="doris_mae_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v6-1_position_penalty+length_penalty [doc present keyphrase expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
python bm25_search_v3.py

INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/doris_mae_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v6-1_position_penalty+length_penalty" \
EXPERIMENT_NAME="doris_mae_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v6-1_position_penalty+length_penalty [query + doc expansion]" \
GROUNDTRUTH_DATA_PATH="" DATASET_NAME="doris_mae" \
QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/doris_mae_queries--retrieval_based_ukg_custom_trained_combined_references_nounphrase_v6-1_position_penalty+length_penalty.json" \
python bm25_search_v3.py
