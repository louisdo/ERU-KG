...
INPUT_FILE = "/scratch/lamdo/unArxive/triplets_full_paper_1citationpersentence.json"
OUTPUT_FILE = "/scratch/lamdo/unArxive/triplets_full_paper_1citationpersentence_mined_phrases.json"
...
if __name__ == "__main__":
    ...
    print(len(new_triplets_data))
    with open(OUTPUT_FILE, "w") as f:
        json.dump(new_triplets_data, f, indent=4)