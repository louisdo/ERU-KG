...
do
    ...
    # INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid" \
    # EXPERIMENT_NAME="trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty [query expansion]" \
    # GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    # QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/trec_covid_queries--retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty.json" \
    # python bm25_search_v3.py

    # INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid" \
    # EXPERIMENT_NAME="trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty [query present keyphrase expansion]" \
    # GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    # QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/trec_covid_queries--retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty.json" \
    # EXPANSION_ONLY_PRESENT_KEYPHRASES=1 \
    # python bm25_search_v3.py

    # INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty" \
    # EXPERIMENT_NAME="trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty [doc expansion]" \
    # GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    # python bm25_search_v3.py

    # INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid_only_present_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty" \
    # EXPERIMENT_NAME="trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty [doc present keyphrase expansion]" \
    # GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    # python bm25_search_v3.py

    # INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty" \
    # EXPERIMENT_NAME="trec_covid_keyphrase_expansion_retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty [query + doc expansion]" \
    # GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    # QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/trec_covid_queries--retrieval_based_ukg_custom_trained_combined_references_nounphrase_v7-${i}_position_penalty+length_penalty.json" \
    # python bm25_search_v3.py
    ...
    # tpg 
    INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid" \
    EXPERIMENT_NAME="trec_covid_tpg-${i} [query expansion]" \
    GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/trec_covid_queries--tpg-${i}.json" \
    python bm25_search_v3.py

    INDEX_PATH="/scratch/lamdo/pyserini_experiments/index/trec_covid" \
    EXPERIMENT_NAME="trec_covid_tpg-${i} [query present keyphrase expansion]" \
    GROUNDTRUTH_DATA_PATH="" DATASET_NAME="trec_covid" \
    QUERY_EXPANSION_PATH="/scratch/lamdo/precompute_keyphrase_extraction/trec_covid_queries--tpg-${i}.json" \
    EXPANSION_ONLY_PRESENT_KEYPHRASES=1 \
    python bm25_search_v3.py
