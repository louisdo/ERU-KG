...
from src.promptrank import promptrank_keyphrase_generation, get_setting_dict, init_promptrank
...
def do_keyphrase_extraction(doc, top_k = 10):
    ...
    #     return keybart_keyphrase_generation(doc, top_k = top_k)
        ...
        init_promptrank(model_run_index=1)
        return promptrank_keyphrase_generation(doc, topk=top_k, model_run_index=1)
